    ...
    async def wrapper(_, message):
        ...
        if message.chat.id in blacklisted_chats_list:
            await message.reply_text(
                f"**Obrolan Daftar Hitam**\n\nObrolan Anda telah dimasukkan dalam daftar hitam oleh Pengguna Sudo. Minta __SUDO USER__ untuk masuk daftar putih.\nPeriksa Daftar Pengguna Sudo [From Here](https://t.me/{BOT_USERNAME}?start=sudolist)"
            )
